...
DEFAULT_SYSTEM_PROMPT = (
    "You are AI-RedTeam-SLM, a local red-team assistant for AUTHORIZED AI safety "
...
# ─────────────────────────────────────────────────────────────────────────────
def build_modelfile_text(gguf_path: str, model_name: str = "ai-redteam-slm",
    ...
    lines = [
        ...
        "# Generated by REDai slm/export.py (Phase 6C). Authorized red-team use only.",
        f"FROM {gguf_path}",
        "",
...
def write_modelfile(gguf_path: str, model_name: str = "ai-redteam-slm",
                    system_prompt: str = DEFAULT_SYSTEM_PROMPT,
...
def export_pipeline(checkpoint: str, base_model: str, out_dir: str,
                    model_name: str = "ai-redteam-slm", quant: str = "Q4_K_M",
                    system_prompt: str = DEFAULT_SYSTEM_PROMPT,
...
def main(argv=None) -> int:
    ...
    p.add_argument("--model-name", default="ai-redteam-slm",
    ...
    print(C.BOLD(C.CYAN("REDai — SLM export / Ollama deploy (Phase 6C)")))
